...
it('Целый путь', function () {
    ...
    cy.get(':nth-child(1) > .auth__input').type('orl.constantin@yandex.ru');
    cy.get('#password').type('123Kostet');
    ...
    cy.get('.pay__input-box-last-of > .pay_base-input-v2').type('Orlovsky Kostya');
